...
function useForm(_a) {
    ...
    function registerFieldsRef(ref, validateOptions) {
        ...
        if (!isEmptyObject(defaultValuesRef.current)) {
            ...
            var shouldSet = __spread(fieldArrayNamesRef.current).reduce(function (prev, current) {
                return isMatchFieldArrayName(name, current) ? false : prev;
            }, true);
...
function useFieldArray(_a) {
    ...
    var _c = __read(React.useState(mapIds(defaultValues[name])), 2), fields = _c[0], setField = _c[1];
    ...
    var reset = function (values) { return setField(mapIds(values[name])); };
